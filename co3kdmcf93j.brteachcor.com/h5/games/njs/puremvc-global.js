/* Browser global wrapper for PureMVC JS Native Port. */
(function(){
/**
 * @fileOverview
...
globalThis.puremvc = puremvc;
(function(pm){
    var defaultKey = "default";
    var originalGetInstance = pm.Facade.getInstance;
    pm.Facade.getInstance = function(key) {
        return originalGetInstance.call(pm.Facade, key == null ? defaultKey : key);
    };
    var originalInitializeNotifier = pm.Notifier.prototype.initializeNotifier;
    pm.Notifier.prototype.initializeNotifier = function(key) {
        return originalInitializeNotifier.call(this, key == null ? defaultKey : key);
    };
    pm.Notifier.prototype.multitonKey = defaultKey;
    pm.Notifier.prototype.facade = pm.Facade.getInstance(defaultKey);
})(puremvc);
})();
